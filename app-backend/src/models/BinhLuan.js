...
module.exports = (sequelize) => {
  const BinhLuan = sequelize.define(
    "BinhLuan",
    {
      ...
      nhan_cam_xuc: { type: DataTypes.ENUM("TICH_CUC", "TIEU_CUC", "CHUA_PHAN_LOAI"), defaultValue: "CHUA_PHAN_LOAI" },
      danh_gia_sao: { type: DataTypes.TINYINT, allowNull: true },
      
      // [MỚI]: TRƯỜNG LƯU LÝ DO ĐÁNH GIÁ SAO
      ly_do_danh_gia_sao: { type: DataTypes.TEXT, allowNull: true },
      ...
      ai_version: { type: DataTypes.STRING(50), defaultValue: "gemini-3.5-flash" },
